...
no it is not present beacuse contanser are pehemeral by default if we removet hem they will remove entrie data by default
...
it will store the data in given floder
